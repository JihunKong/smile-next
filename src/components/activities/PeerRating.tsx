...
export function PeerRating({ questionId, initialRating, compact = false, onRate }: PeerRatingProps) {
    ...
    >
      {[1, 2, 3, 4, 5].map((star) => (
        <button
          ...
          onMouseEnter={() => setHoverRating(star)}
          disabled={isSubmitting}
          className="p-0.5 focus:outline-none focus:ring-2 focus:ring-yellow-400 rounded disabled:opacity-50"
        >
          <svg
