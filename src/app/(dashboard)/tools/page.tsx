...
const tools: Tool[] = [
  {
    id: 'activity-maker',
    name: 'AI Activity Maker',
    description: 'Create inquiry-based activities with AI-generated questions',
    href: '/tools/activity-maker',
    color: 'from-[var(--stanford-cardinal)] to-[var(--stanford-pine)]',
    available: true,
    icon: (
