...
export default async function CasePage({ params }: CasePageProps) {
  ...
  // Check if case study is published (default to true for backwards compatibility)
  const isPublished = caseSettings.is_published !== false
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-3xl mx-auto px-4 py-8">
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center">
            ...
            <h2 className="text-lg font-semibold text-yellow-800 mb-2">Case Study Not Available</h2>
            <p className="text-yellow-700">
              This case study has not been published yet. Please check back later or contact your instructor.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-yellow-100 border-b border-yellow-200 px-4 py-3">
          <div className="max-w-3xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-yellow-800 font-medium">This case study is not published yet</span>
            </div>
            <Link
